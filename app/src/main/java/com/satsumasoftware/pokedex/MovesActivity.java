...
import com.satsumasoftware.pokedex.adapter.MoveDexAdapter;
...
public class MovesActivity extends BaseActivity implements FilterListItemVGAdapter.OnFilterItemClickListener {
    ...
    private MoveDBHelper mDbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbHelper = new MoveDBHelper(this);
        populateList(mDbHelper.getAllMoves());
    ...
    private void populateList(ArrayList<MiniMove> items) {
        ...
        Collections.sort(items, new Comparator<MiniMove>() {
            @Override public int compare(MiniMove move1, MiniMove move2) {
                if (mSortByName) {
                    return move1.getMove().compareTo(move2.getMove()); // Ascending
                } else {
                    return move1.getMoveId() - move2.getMoveId(); // Ascending
                }
            }
        ...
        adapter.setOnRowClickListener(new MoveDexAdapter.OnRowClickListener() {
            ...
            public void onRowClick(View view, int position) {
                ...
                intent.putExtra("MOVE", itemsFinal.get(position));
        ...
        spinnerName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (text.equalsIgnoreCase("no filter")) {
                    ...
                    mFilterSelectionName = "(LOWER(" + MoveDBHelper.COL_NAME + ") LIKE \"" +
                            text.toLowerCase() + "%\")";
                }
                updateFilteredList();
            }
    ...
    public void onFilterItemClick(View view, int position, String text, boolean isChecked, View itemView) {
        switch (itemView.getId()) {
            case R.id.filterDrawer_llType_content:
                String typeQuery = "(LOWER(" + MoveDBHelper.COL_TYPE + ")=\"" + text.toLowerCase() + "\")";
            ...
            case R.id.filterDrawer_llGen_content:
                String genQuery = "(" + MoveDBHelper.COL_GENERATION + "=\"" +
    ...
    private void updateFilteredList() {
        ...
        String[] columns = new String[] {
                ...
                MoveDBHelper.COL_TYPE,
                MoveDBHelper.COL_GENERATION
        };
        ...
        while (!cursor.isAfterLast()) {
            int id = cursor.getInt(cursor.getColumnIndex(MoveDBHelper.COL_ID));
            String name = cursor.getString(cursor.getColumnIndex(MoveDBHelper.COL_NAME));
