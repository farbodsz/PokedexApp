...
import com.satsumasoftware.pokedex.adapter.FilterListItemVGAdapter;
...
public class PokedexActivity extends BaseActivity implements FilterListItemVGAdapter.OnFilterItemClickListener {
    ...
    private PokedexDBHelper mDbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbHelper = new PokedexDBHelper(this);
    ...
    private void populateList(ArrayList<MiniPokemon> pokemonList) {
        ...
        Collections.sort(pokemonList, new Comparator<MiniPokemon>() {
            ...
            public int compare(MiniPokemon pokemon1, MiniPokemon pokemon2) {
                if (mSortByName) {
                    return pokemon1.getPokemon().compareTo(pokemon2.getPokemon()); // Ascending
                } else {
                    return pokemon1.getNationalId() - pokemon2.getNationalId(); // Ascending
                }
            }
        });
        ...
        adapter.setOnEntryClickListener(new PokedexAdapter.OnEntryClickListener() {
            ...
            public void onEntryClick(View view, int position) {
                ...
                intent.putExtra("POKEMON", listFinal.get(position));
        ...
        spinnerName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (text.equalsIgnoreCase("no filter")) {
                    ...
                    mFilterSelectionName = "(LOWER(" + PokedexDBHelper.COL_NAME + ") LIKE \"" +
                            text.toLowerCase() + "%\")";
                }
                updateFilteredList();
            }
    ...
    public void onFilterItemClick(View view, int position, String text, boolean isChecked, View itemView) {
        switch (itemView.getId()) {
            case R.id.filterDrawer_llType_content:
                String typeQuery = "((LOWER(" + PokedexDBHelper.COL_TYPE_1 + ")=\"" + text.toLowerCase() + "\") OR " +
                        "(LOWER(" + PokedexDBHelper.COL_TYPE_2 + ")=\"" + text.toLowerCase() + "\"))";
            ...
            case R.id.filterDrawer_llGrowth_content:
                String growthQuery = "(LOWER(" + PokedexDBHelper.COL_LEVELLING_RATE + ")=\"" +
                        InfoUtils.getAbbreviationFromGrowth(text).toLowerCase() + "\")";
            ...
            case R.id.filterDrawer_llGen_content:
                String genQuery = "(" + PokedexDBHelper.COL_GENERATION + "=\"" +
    ...
    private void updateFilteredList() {
        ...
        String[] columns = new String[] {
                ...
                PokedexDBHelper.COL_FORM,
                PokedexDBHelper.COL_TYPE_1,
                PokedexDBHelper.COL_TYPE_2,
                PokedexDBHelper.COL_LEVELLING_RATE,
                PokedexDBHelper.COL_GENERATION
        };
