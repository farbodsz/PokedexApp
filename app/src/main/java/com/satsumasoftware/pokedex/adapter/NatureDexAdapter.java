...
public class NatureDexAdapter extends RecyclerView.Adapter<NatureDexAdapter.NatureViewHolder> {
    ...
    private ArrayList<Nature> mArrayNatures;

    public NatureDexAdapter(ArrayList<Nature> arrayNatures) {
    ...
    public void onBindViewHolder(NatureViewHolder holder, int position) {
        Nature nature = mArrayNatures.get(position);
        holder.textView.setText(nature.getNatureName());
    }
