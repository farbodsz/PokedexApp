...
public class PkmnTypeDetailActivity extends AppCompatActivity {
    ...
    private void setupLayout() {
        TextView tvTitle = (TextView) findViewById(R.id.pkmnTypeDetail_tvTitle);
        ListView lvImmune = (ListView) findViewById(R.id.pkmnTypeDetail_lvImmune);
        ListView lvStrong = (ListView) findViewById(R.id.pkmnTypeDetail_lvStrong);
        ListView lvWeak = (ListView) findViewById(R.id.pkmnTypeDetail_lvWeak);
        ...
        tvTitle.setText(InfoUtils.getNameAndForm(mPokemon));
